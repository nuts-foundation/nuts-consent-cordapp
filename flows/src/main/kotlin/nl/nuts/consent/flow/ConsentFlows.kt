...
//
    ...
    @InitiatingFlow
    @StartableByRPC
    class MergeFlow(val branchUUID:UniqueIdentifier) : FlowLogic<SignedTransaction>() {
        ...
        override fun call(): SignedTransaction {
            ...
            val newState = ConsentState(consentStateUUID = consentRef.state.data.consentStateUUID,
